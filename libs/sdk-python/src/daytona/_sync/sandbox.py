...
class Sandbox(SandboxDto):
    ...
    def _experimental_pause(self, timeout: float = 60) -> None:
        ...
        self._sandbox_api.pause_sandbox(self.id, _request_timeout=timeout if timeout > 0 else None)
        self._refresh_data()
    ...
    def _experimental_resume(self, timeout: float = 60) -> None:
        ...
        start_time = time.time()
        self._sandbox_api.resume_sandbox(self.id, _request_timeout=timeout if timeout > 0 else None)
        self._refresh_data()
